...
// These keys are query params that eventually we will use to sort the results
const SORT_BY_MAP = {
  r: "Default",
  rv: "By review",
  ...
  return (
    <header className="flex flex-col items-center md:flex-row md:items-start md:space-x-6 px-2 pt-10 pb-5 md:p-10 md:pb-5">
      ...
      <div className="w-full md:max-w-2xl">
        ...
        >
          <div className="flex items-center gap-2 w-full px-4">
            <div className="flex items-center space-x-2 bg-white shadow-xl rounded-full px-6 py-4 md:max-w-5xl flex-1">
      ...
      <div className="hidden lg:flex flex-1 justify-end">
        {/* Avatar */}
        <Avatar name="Carlos Gomes" size="50" round={true} />
      </div>
    </header>
  );
}
