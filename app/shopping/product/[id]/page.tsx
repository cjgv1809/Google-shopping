    ...
    <div className="p-12 pt-0">
      ...
      <section className="flex flex-col lg:flex-row mt-5 md:mt-0">
        <div className="md:p-10 md:pl-0 mx-auto">
            ...
            <div className="flex flex-col justify-between">
              {productData.content.images?.full_size
                ...
                .map((image, i) => (
                  <img
                    key={i}
                    className="h-[9.5rem] w-[9.5rem] object-contain border rounded-md"
                    src={image}
                    alt=""
                  />
                ))}
          ...
          <div className="flex space-x-6 overflow-x-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100 py-2 md:w-[30rem]">
            ...
            {productData.content?.highlights && (
              <div className="mt-5 space-y-2">
                ...
                <ul className="space-y-2">
                  {productData.content.highlights?.map((highlight, index) => (
                    <li
                      key={highlight.toString() + index}
                      className="list-disc"
                    >
                      {highlight}
                    </li>
